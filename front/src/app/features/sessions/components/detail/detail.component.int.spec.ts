...
describe('DetailComponent', () => {
  ...
  it('should display delete button but not participate button if user is admin', () => {
    ...
    const participateButton = fixture.nativeElement.querySelector('#participateBtn');
  ...
  it('should unparticipate in session', () => {
    ...
    const participateButton = fixture.nativeElement.querySelector('#unparticipateBtn');
    participateButton.click();
  ...
  it('should go back', () => {
    ...
    const backButton = fixture.nativeElement.querySelector('#backBtn');
    backButton.click();
