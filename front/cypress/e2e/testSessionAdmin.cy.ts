describe('Testing session component as user', () => {
  ...
  it('should edit a session', () => {
    ...
    cy.get('mat-select[formControlName="teacher_id"]').should('contain.text', 'teacherFirstName teacherLastName');
    cy.get('textarea[formControlName="description"]').should('have.value', 'Description 1');
